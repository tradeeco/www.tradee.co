...
@section('custom-styles')
    {!! Html::style('backend/css/pages/category.css?'.time()) !!}
@endsection
                    ...
                    <div class="row m-b categories">
                        @if(Form::old('name'))
                            @foreach(old('name') as $key => $val)
                                <div class="col-sm-4 m-b cat-input-wrap {!! $errors->first('name.'.$key, 'has-error') !!}">
                            ...
                            @endforeach
                        @else
                        <div class="col-sm-4 m-b cat-input-wrap">
...
@section('custom-scripts')
    {!! Html::script('backend/js/pages/category.js?'.time()) !!}
    <script>
        Category.init();
    </script>
@endsection
