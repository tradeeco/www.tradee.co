        ...
        <div class="tab-v2">
            <ul class="nav nav-tabs">
                <li class="{{ getActionName(Route::getCurrentRoute()->getActionName()) == 'mine' ? 'active' : '' }}">
                    <a href="{{ URL::route('jobs.mine') }}" aria-expanded="false">My jobs</a></li>
                <li class="{{ getActionName(Route::getCurrentRoute()->getActionName()) == 'previous' ? 'active' : '' }}" ><a href="{{ URL::route('jobs.previous') }}">Previous jobs</a></li>
            </ul>
                            ...
                            <table class="table">
                                ...
                                @foreach ($jobs as $job)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-primary rounded white-color" id="close_listing">close listing</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
